...
// private wrong guesses and a 10-second per-round timer.
export const PHOTO_QUICK_MATCH_PRESETS = [
  { key: "quick", label: "First to 1", detail: "First to win a round · 10s" },
  { key: "standard", label: "First to 3", detail: "First to 3 wins · 10s" },
  { key: "long", label: "First to 5", detail: "First to 5 wins · 10s" },
];

export const DEFAULT_PHOTO_QUICK_MATCH_PRESET = "standard";

// The backend gives each public round a 10-second timer; the board mirrors it
// client-side because the realtime layer does not push a per-round deadline.
export const PHOTO_QUICK_MATCH_ROUND_SECONDS = 10;
